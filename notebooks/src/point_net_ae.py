...
from . external.ChamferDistanceAPI.chamferdistance.tf_nndistance import nn_distance
...
#     from . external.structural_losses.tf_nndistance import nn_distance
    ...
    print('External Losses (nn_distance) cannot be loaded. Please install them first.')
try:    

    from . external.structural_losses.tf_approxmatch import approx_match, match_cost
except:
    print('External Losses (match_cost) cannot be loaded. Please install them first.')
